...
- For **UI styling and Signatur’s target visual system** (dark literary palette, typography, components), read and follow [`Style.md`](/Style.md) at the repo root when building or reviewing Blade, Tailwind, Flux, or Livewire UI.
